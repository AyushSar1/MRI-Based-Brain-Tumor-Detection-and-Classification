...
if st.session_state["photo"] == "Done":
    ...
    resized_image = test_image.resize((150, 150))
    st.image(resized_image, caption='Example Image', width = True)
...
if st.button("GitHub Repository"):
    st.markdown('(https://github.com/your-username/your-project)', unsafe_allow_html=True)

with st.expander("Click here to read more"):
    st.write("This project is a made by Ayush Sarkar")
